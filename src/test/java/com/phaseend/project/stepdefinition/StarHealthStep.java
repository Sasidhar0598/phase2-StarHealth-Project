package com.phaseend.project.stepdefinition;

import org.junit.Assert;
import org.openqa.selenium.By;

import com.phaseend.project.base.BaseTest;
import com.phaseend.project.pages.BuyNowPage;
import com.phaseend.project.pages.HomePage;
...
public class StarHealthStep {
	...
	@Then("User types Email as {string}")
	public void user_types_email_as(String Email) throws InterruptedException {
		//email=Email;
		buyNowPage.give_email(Email);
	}
	...
	public void the_application_should_redirect_to_the_home_page() throws InterruptedException {
		String actualTitle = homePage.get_homepage_title();
		String expectedTitle = "Comprehensive Health Insurance Policy | StarHealth.in";
